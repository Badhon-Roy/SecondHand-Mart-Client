        ...
        <section className="py-20 bg-gradient-to-r from-[#ff8e00] to-[#ffbe0c] text-white text-center rounded-lg">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex justify-center items-center space-x-4">
                    ...
                    />
                    <Button className="bg-gradient-to-r from-[#ffbe0c] to-[#ff8e00] py-7 px-8 rounded-md text-white font-semibold text-xl shadow-lg transition-all border transform hover:scale-105 hover:bg-[#ff6f00] hover:shadow-xl active:scale-95">
                        Subscribe
                    </Button>
                </div>
            </div>
