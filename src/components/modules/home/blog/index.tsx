    ...
    return (
        <div className="my-16">
            ...
            <div className="flex items-center justify-end ">
                <Link href={'/blogs'}>
                    <Button className="bg-gradient-to-r from-[#ffbe0c] to-[#ff8e00] md:px-8 md:py-6 px-2 md:text-[18px]  rounded-[4px] text-white font-semibold shadow-md transform transition-transform duration-300 hover:scale-105 hover:from-[#e9a912] hover:to-[#ff6f00] hover:shadow-lg active:scale-95 focus:outline-none cursor-pointer mt-2">
                        Explore More
                    </Button></Link>
            </div>
                                ...
                                <div className="lg:flex justify-between gap-4 my-4">
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="md:text-[16px] text-sm">{blog?.user?.email}</p>
                                        </div>
                                    </div>
                                    <div>
